...
public class Main {
    ...
    public static void main(String[] args){
        ...
        System.out.println("======================================");
        System.out.println("Producto mas caro: "+ main.maxAndMin(productos).get(1).getProductName());
        System.out.println("Producto mas barato: "+ main.maxAndMin(productos).get(0).getProductName());
    }
    ...
    public ArrayList<Product> maxAndMin(ArrayList<Product> productos){
